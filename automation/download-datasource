####
# This script contains functions that download a datasource
# from a server default project.
# 
...
#   python download_datasource.py <server_address> <username>
#
# When running the script, it will prompt for the following:
# 'Name of datasource to download':        Enter name of datasource to download
